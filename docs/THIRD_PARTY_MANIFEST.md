...
Snapshot date: **2026-09-23**. SHAs below are observed public default-branch snapshots used for reference qualification, not vendored dependencies.
...
| cocotbext-axi | https://github.com/alexforencich/cocotbext-axi | `264319c17f0869e4d0efb15ad0e6d74e3bef453c` | MIT LICENSE observed | qualified verification-only dependency, package pin 0.1.28 | no; installed as a Python package |
