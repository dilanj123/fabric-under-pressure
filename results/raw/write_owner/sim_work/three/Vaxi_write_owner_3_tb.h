...
#ifndef VERILATED_VAXI_WRITE_OWNER_3_TB_H_
#define VERILATED_VAXI_WRITE_OWNER_3_TB_H_  // guard

#include "verilated.h"

class Vaxi_write_owner_3_tb__Syms;
class Vaxi_write_owner_3_tb___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) Vaxi_write_owner_3_tb VL_NOT_FINAL : public VerilatedModel {
    friend class Vaxi_write_owner_3_tb__Syms;
  private:
    // Symbol table holding complete model state (owned by this class)
    Vaxi_write_owner_3_tb__Syms* const vlSymsp;
    // Evaluation loop
  ...
  public:
    ...
    Vaxi_write_owner_3_tb___024root* const rootp;
    ...
    explicit Vaxi_write_owner_3_tb(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxi_write_owner_3_tb(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxi_write_owner_3_tb();
  private:
    VL_UNCOPYABLE(Vaxi_write_owner_3_tb);  ///< Copying not allowed
